...
const Chatbot = () => {
  ...
  return (
    <>
      {/* <h1 className="mb-2 font-bold">KrishiMitra: Your Smart Agriculture Assistant</h1> */}
   
      {/* <div>
      <h1>Modify Targets</h1>
      {aiResponse ? (
        <pre className="bg-gray-100 p-4 rounded-md">{JSON.stringify(aiResponse, null, 2)}</pre>
      ) : (
        <p>No data available. Please navigate with valid AI response data.</p>
      )}
    </div> */}
    {/* {console.log("aiResponse::::", aiResponse)} */}


    {/* {console.log("aiResponse String Format:", JSON.stringify(aiResponse))} */}
